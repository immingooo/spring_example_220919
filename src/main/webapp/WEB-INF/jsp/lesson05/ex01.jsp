...
<body>
	...
	<%-- 문구 그대로 출력된다 --%>
	<c:out value="<script>alert('얼럿창 띄우기');</script>" />  <%-- escapeXml="true"가 디폴트 --%>
	
	<%-- 문구 그대로 출력된다 --%>
	<c:out value="<script>alert('얼럿창 띄우기');</script>" escapeXml="true" /> 
	
	<%-- 스크립트가 수행된다 --%>
	<c:out value="<script>console.log('얼럿창 띄우기');</script>" escapeXml="false" /> <%-- 원래 alert --%>
	<%-- <script>console.log('얼럿창 띄우기');</script> --%>
